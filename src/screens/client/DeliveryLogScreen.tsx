    ...
    const {
        ...
        queryFn: async () => {
            ...
            return (data || []).map((d: any) => ({
                ...
                pickup_photo_url: d.pickup_photo_url || null,
                pickup_photo_uploaded_at: d.pickup_photo_uploaded_at || null,
                proof_photo_url: d.proof_photo_url || d.proof_of_delivery_url || d.image_url || null,
                proof_photo_uploaded_at: d.proof_photo_uploaded_at || null,
                return_photo_url: d.return_photo_url || null,
                return_photo_uploaded_at: d.return_photo_uploaded_at || null,
